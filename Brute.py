...
banner = """
      ...
      .aMMMb  dMMMMb  dMMMMMP .aMMMb  dMP dMP dMMMMMP dMMMMb
     dMP"VMP dMP.dMP dMP     dMP"VMP dMP.dMP dMP     dMP.dMP
     dMP     dMMMMK" dMMMP   dMP     dMMMMK" dMMMP   dMMMMK"  
      dMP.aMP dMP"AMF dMP     dMP.aMP dMP"AMF dMP     dMP"AMF
  VMMMP" dMP dMP dMMMMMP  VMMMP" dMP dMP dMMMMMP dMP dMP    
